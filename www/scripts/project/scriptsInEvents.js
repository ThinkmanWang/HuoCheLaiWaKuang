...
const scriptsInEvents = {
	...
	async Es_level_Event549_Act1(runtime, localVars)
	{
		PokiSDK.customEvent('game', 'segment', { segment: 'level'+runtime.globalVars.Level_Max });
	},

	async Es_loader_Event7_Act1(runtime, localVars)
	{
